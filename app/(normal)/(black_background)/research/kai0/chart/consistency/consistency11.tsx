...
const chartData = [
    { trick: "baseline", absolute: 36.7, absolute_std: [4, 4], delta: 36.7, delta_std: [4, 4], },
    { trick: "+spatio-temp.\naugment", absolute: 50, absolute_std: [4.71, 4.71], delta: 76.7, delta_std: [4.71, 4.71], },
]
...
export function ConsistencyBarChart11() {
    return (
