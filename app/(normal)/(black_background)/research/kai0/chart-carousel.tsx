        ...
        <div className="absolute left-2 sm:left-4 lg:left-0 top-1/2 -translate-y-1/2 lg:-translate-x-12 z-20">
          <button
            ...
            className={`
              ...
              ${canScrollPrev 
                ? "hover:bg-white/20 hover:border-white/30 hover:scale-110 active:scale-95 cursor-pointer" 
          ...
          >
            <ChevronLeft 
              className={`
                w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white
        ...
        {chartSections.map((_, index) => (
          <button
            ...
            className={`
              ...
              rounded-full
              ${index === current 
                ? "w-8 h-2 bg-white shadow-[0_2px_8px_rgba(255,255,255,0.3)]" 
                : "w-2 h-2 bg-white/30 hover:bg-white/50 hover:w-3"
              }
            `}
